...
<header class="tag-header">
	...
	<?php
	// === Pronunce (blocco nascosto con toggle) ===
	if ( $readings && function_exists( 'cz_render_readings_block' ) ) {
		cz_render_readings_block( $readings, 'term-' . $term->term_id, 'Pronunce' );
	}
	?>
	...
	<?php if ( $short_definition || $full_description || $wp_description ) : ?>
		<div class="tag-definition">
			...
			<!-- Nasconde la fonte della definizione
