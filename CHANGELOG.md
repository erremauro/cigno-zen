...
## [2.9.4] 2026-09-11
### Fixed
- Strip leading paragraph number from paginated sub-page meta description (e.g. "22 Qual è..." → "Qual è...")

## [2.9.3] 2026-09-11
### Fixed
- Fix duplicate <title> and meta description across paginated sub-pages of long posts (<!--nextpage-->) — all ~90 sub-pages of the same post previously shared identical title/description, a duplicate-content signal likely contributing to "crawled - not indexed" status

## [2.9.2] 2026-09-11
### Added
- Dynamic noindex,follow on post_tag (lemma) archives with zero linked articles, via the core `wp_robots` filter (no conflict with SEO plugin output)

## [2.9.1] 2026-09-11
### Fixed
- Redirect 301 legacy /author/{login} URLs to the current /autore/{login} base (was returning 404 for old permalinks still referenced externally/in old sitemaps)

## [2.9.0] 2026-09-10
### Changed
- Add publishing date informations
- Add e compact view for article list
- Updates the result layout for search results
### Fixed
- Fix translation for search result title

## [2.8.4] 2026-09-10
### Fixed
- Fix an issue with the rendering of newer version of cz-highilights plugin

## [2.8.3] 2026-09-01
### Changed
- Article's note has been moved before the pagination section

## [2.8.2] 2026-07-31
### Fixed
- The `autore` and `maestro` shortcodes now generate URLs that consistently end with a trailing slash.
- On mobile, the total reading time label and its value now wrap onto separate lines.

## [2.8.1] 2026-07-29
### Fixed
- Add nounce on login
- "Noto Serif JP" font style is now served directly from the website
...
## [2.7.5] 2026-06-17
### Changed
- The subtitle has been added for the featured article in the home page.
...
## Fixed
- Restore ebook download buttons in `template-single-volume.php`
...
[Unreleased]: https://github.com/erremauro/cigno-zen/compare/v2.8.2...HEAD
[2.8.2]: https://github.com/erremauro/cigno-zen/releases/tag/v2.8.2
[2.8.1]: https://github.com/erremauro/cigno-zen/releases/tag/v2.8.1
...
[2.5.2]: https://github.com/erremauro/cigno-zen/releases/tag/v2.5.2
[2.5.1]: https://github.com/erremauro/cigno-zen/releases/tag/v2.5.1
[2.5.0]: https://github.com/erremauro/cigno-zen/releases/tag/v2.5.0
[2.4.1]: https://github.com/erremauro/cigno-zen/releases/tag/v2.4.1
[2.4.0]: https://github.com/erremauro/cigno-zen/releases/tag/v2.4.0
